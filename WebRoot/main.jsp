				...
				<div class="panel-group" id="accordion">
					...
					<div class="panel panel-default">
						...
						<div id="collapseSix" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="list-group">
									<li class="list-group-item" id = "14"><span onclick="main14()">校区管理</span></li>
									<li class="list-group-item" id = "15"><span onclick="main15()">市场管理</span></li>
									<li class="list-group-item" id = "16"><span onclick="main16()">决策管理</span></li>
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="list-group">
									<li class="list-group-item" id = "4"><a href = "organization.jsp">学员信息登记和查询</a></li>
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse">
							<div class="panel-body">
								<ul class="list-group">
									<li class="list-group-item" id = "7"><span onclick="main7()">收入支出录入</span></li>
									<li class="list-group-item" id = "8"><span onclick="main8()">收入支出审核</span></li>
									<li class="list-group-item" id = "9"><span onclick="main9()">财务状况查询</span></li>
							    </ul>
							</div>
						</div>
					</div>
