...
/**
 * Servlet implementation class Hrm2Servlet
 */
@WebServlet("/Hrm2Servlet")
public class Hrm2Servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int tid =Integer.parseInt(request.getParameter("thirdorg3"));
		 ...
		 List<hrm1> hrm11 = addthingService.Searchalldecisons(hrms);
		 session.setAttribute("hrm11", hrm11);
		 request.getRequestDispatcher("syso.jsp").forward(request, response);
