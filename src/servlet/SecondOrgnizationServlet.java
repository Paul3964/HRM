...
//		System.out.println(callBack);
		List<Organization> lists = firstOrganizationService.getAllSecond(Integer.parseInt(pid));
//		System.out.println(lists);
		StringBuffer sb = new StringBuffer(callBack+"([");
		for(Organization organization:lists){
				sb.append("{\"sname\":\""+organization.getFirstorg()+"\",\"sid\":"+"\""+organization.getFid()+"\"},");
		}
		sb.append("])");
