...
@WebServlet("/third")
public class ThirdOrganizationServlet extends HttpServlet {
	 ...
	 */
	public ThirdOrganizationServlet() {
		super();
	}
...
//		System.out.println(callBack);
		List<Organization> lists = firstOrganizationService.getAllThird(Integer.parseInt(pid1));
//		System.out.println(lists);
		StringBuffer sb = new StringBuffer(callBack+"([");
		for(Organization organization:lists){
				sb.append("{\"tname\":\""+organization.getFirstorg()+"\",\"tid\":"+"\""+organization.getFid()+"\"},");
		}
		sb.append("])");
